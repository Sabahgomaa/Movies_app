...
import 'package:movies_app/Movies/Presentation/Controller/movie_details_states.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<MovieDetailsBloc>()
        ...
        ..add(GetMovieRecommendationEventEvent(id)),
        ...
        builder: (context, state) {
          return SliverGrid(
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                final recommendation = state.recommendationDetails[index];
                return FadeInUp(
                  from: 20,
                  duration: const Duration(milliseconds: 500),
                  child: ClipRRect(
              ...
              childCount: state.recommendationDetails.length,
            ),
